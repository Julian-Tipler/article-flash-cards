...
export default function LoginPage() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center">
      <div className="flex w-50 flex-col justify-center items-center gap-2 mb-36">
        ...
        <div>
          <button
            type="button"
            className="py-2 px-3 max-w-md w-52 flex justify-start items-center bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200 text-white transition ease-in duration-200 text-center shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-md text-sm h-10"
